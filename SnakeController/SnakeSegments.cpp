...
{
   int temporaryXValueOfThePosition=position.x;
   int temporaryYValueOfThePosition=position.y;
    return m_segments.end() !=  std::find_if(m_segments.cbegin(), m_segments.cend(),
        [temporaryXValueOfThePosition, temporaryYValueOfThePosition](auto const& segment){ return segment.x == temporaryXValueOfThePosition && segment.y == temporaryYValueOfThePosition; });
}
